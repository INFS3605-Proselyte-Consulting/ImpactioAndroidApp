...
public class ChallengesToDoActivity extends MainActivity{

    private static final String TAG = "ChallengesToDoActivity";
    private ChallengeAdapter mAdapter;

    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_challenges_dashboard);
        setTitle("Challenges To Do");
        ...
        mAdapter = new ChallengeAdapter(Challenge.getChallengesToDo(), listener);
