...
public class ChallengesInProgressActivity extends MainActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter = new ChallengeAdapter(Challenge.getChallengesInProgress(), listener);
